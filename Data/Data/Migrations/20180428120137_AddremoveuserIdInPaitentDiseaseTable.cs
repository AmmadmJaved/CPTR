...
{
    public partial class AddremoveuserIdInPaitentDiseaseTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiseaseLevel = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientDisease", x => x.DiseaseId);
                    table.ForeignKey(
                        name: "FK_PatientDisease_PatientUsers_PatientUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientDisease_PatientUserId",
